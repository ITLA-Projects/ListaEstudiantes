...
<link href="{$directory}assets\css\styles.css" rel="stylesheet" type="text/css">
  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    ...
    <h3 class="text-center text-white">Lista de Estudiantes By - Miguel Angel Peña Santos - 2018-6717</h3>
